;; init-ligature.el --- fira-code-ligature-setting.	-*- lexical-binding: t -*-

;;; Commentary:
;;
;; fira-code-ligature-setting.
;;

;;; Code:

;; This works when using emacs --daemon + emacsclient
(add-hook 'after-make-frame-functions (lambda () (set-fontset-font t '(#Xe100 . #Xe16f) "Fira Code Symbol")))
